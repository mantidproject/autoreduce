...
if not os.path.exists(expiniFilename):
    expiniFilename="/SNS/lustre/NOM/IPTS-17210/shared/autoNOM_August2016_calibrants/exp.ini"
...
if can_run > 0:
    ...
    canProcessingOtherProperties = ["ResampleX="+str(resamplex),
                                    ...
                                    "CalibrationFile=/SNS/NOM/IPTS-17210/shared/NOM_calibrate_d78208_2016_08_19.h5"]
