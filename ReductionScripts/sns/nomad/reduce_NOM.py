...
if not os.path.exists(expiniFilename):
    expiniFilename="/SNS/lustre/NOM/IPTS-17210/shared/autoNOM_standards_we/exp.ini"
...
if can_run > 0:
    ...
    canProcessingOtherProperties = ["ResampleX="+str(resamplex),
                                    ...
                                    "CalibrationFile=/SNS/NOM/IPTS-17210/shared/NOM_calibrate_d77540_2016_07_25.h5"]
