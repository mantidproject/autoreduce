...
if not os.path.exists(expiniFilename):
    expiniFilename="/SNS/lustre/NOM/IPTS-4480/shared/autoNOM_Mar31/recal68587/exp.ini"
...
if can_run > 0:
    ...
    canProcessingOtherProperties = ["ResampleX="+str(resamplex),
                                    ...
                                    "CalibrationFile=/SNS/NOM/IPTS-4480/shared/NOM_calibrate_d68588_2016_04_04.h5"]
