...
if not os.path.exists(expiniFilename):
    expiniFilename="/SNS/lustre/NOM/IPTS-17210/shared/autoNOM_BaTiO_try2/autoNOM_BaTiO_try2/exp.ini"
...
if can_run > 0:
    ...
    canProcessingOtherProperties = ["ResampleX="+str(resamplex),
                                    ...
                                    "CalibrationFile=/SNS/NOM/IPTS-17210/shared/NOM_calibrate_d77540_2016_08_31.h5"]
