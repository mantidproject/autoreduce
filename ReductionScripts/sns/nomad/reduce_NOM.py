...
if not os.path.exists(expiniFilename):
    expiniFilename="/SNS/lustre/NOM/IPTS-15201/shared/autoNOM3/exp.ini"
...
if False: # can_run > 0:
    ...
    canProcessingOtherProperties = ["ResampleX="+str(resamplex),
                                    ...
                                    "CalibrationFile=/SNS/NOM/IPTS-15201/shared/NOM_calibrate_d67901_2016_03_21.h5"]
    ...
    if False: # os.path.exists(canCacheName):
