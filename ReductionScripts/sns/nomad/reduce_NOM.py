...
if not os.path.exists(expiniFilename):
    expiniFilename="/SNS/lustre/NOM/IPTS-15164/shared/JueatuoNOM400500Kback/exp.ini"
...
if can_run > 0:
    ...
    canProcessingOtherProperties = ["ResampleX="+str(resamplex),
                                    ...
                                    "CalibrationFile=/SNS/NOM/IPTS-15164/shared/NOM_calibrate_d68588_2016_04_06.h5"]
