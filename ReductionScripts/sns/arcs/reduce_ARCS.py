...
if __name__ == "__main__":
    ...
    ProcessedVanadium="/SNS/ARCS/shared/autoreduce/vanadium_files/van108467_new.nxs"
    HardMaskFile=''
    ...
    MaskBTPParameters.append({'Tube': '8', 'Pixel': '48-92', 'Bank': '69'})
    MaskBTPParameters.append({'Tube': '1', 'Pixel': '48-92', 'Bank': '72'})
    ...
    if not math.isnan(Ei):
        ...
        EnergyTransferRange = [-2.0*EGuess,0.01*EGuess,0.95*EGuess] #Energy Binning
        reduceMono(
