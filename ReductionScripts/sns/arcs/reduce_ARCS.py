...
if __name__ == "__main__":
    ...
    ProcessedVanadium="/SNS/ARCS/shared/autoreduce/vanadium_files/van74333_no6_no95_no77.nxs"
    HardMaskFile=''
    ...
    MaskBTPParameters.append({'Bank': '95'})
    MaskBTPParameters.append({'Bank': '77'})
