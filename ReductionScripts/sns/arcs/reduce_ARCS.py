...
if __name__ == "__main__":
    ...
    RawVanadium="/SNS/ARCS/IPTS-16075/data/ARCS_81706_event.nxs"
    ProcessedVanadium="/SNS/ARCS/shared/autoreduce/vanadium_files/van81706_no6_elastic.nxs"
    HardMaskFile=''
    ...
    if not math.isnan(Ei):
        ...
        EnergyTransferRange = [-0.08*EGuess,0.01*EGuess,0.08*EGuess] #Energy Binning
        reduceMono(
