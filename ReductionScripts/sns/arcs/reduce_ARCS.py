...
if __name__ == "__main__":
    ...
    RawVanadium="/SNS/ARCS/IPTS-17350/data/ARCS_86508_event.nxs"
    ProcessedVanadium="/SNS/ARCS/shared/autoreduce/vanadium_files/van86508_p1_p2.nxs"
    HardMaskFile=''
    ...
    MaskBTPParameters.append({'Bank': '1'})
    MaskBTPParameters.append({'Bank': '2'})
    ...
    if not math.isnan(Ei):
        ...
        EnergyTransferRange = [-0.5*EGuess,0.002*EGuess,0.95*EGuess] #Energy Binning
        reduceMono(
