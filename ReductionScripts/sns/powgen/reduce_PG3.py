...
cal_file  = os.path.join(cal_dir,'PG3_JANIS_HT_d41062_2018_07_17.h5') # contains ALL grouping
char_backgrounds = os.path.join(cal_dir, "PG3_char_2018_07_19-HighRes-JANIS_HT.txt")
