...
class processInputs(object):
    def __init__(self):
        #templated stuff
        self.ub_matrix_file='/SNS/CORELLI/IPTS-14525/shared/UB_6K1st.mat' #'/SNS/CORELLI/IPTS-12310/shared/Sr214-Tb1000-2nd-20150512/UB-H0L-may12.mat'
...
if __name__ == "__main__":
    ...
    mdraw = ConvertToMD(raw,QDimensions="Q3D",dEAnalysisMode="Elastic",Q3DFrames=Q3DFrames,QConversionScales=QConversionScales,
                        ...
                        MinValues='-5.1,-10.1,-1.5',MaxValues='5.1,0.1,1.5',
