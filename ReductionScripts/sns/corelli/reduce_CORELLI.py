...
class processInputs(object):
    def __init__(self):
        #templated stuff
        self.ub_matrix_file='/SNS/CORELLI/IPTS-15796/shared/20160229-Ca3Mn2O7/Ca3Mn2O7_UB_Cooling.mat' #'/SNS/CORELLI/IPTS-12310/shared/Sr214-Tb1000-2nd-20150512/UB-H0L-may12.mat'
        ...
        self.plot_requests=[{'Minimum': '-0.10', 'PerpendicularTo': '[0,0,L]', 'Maximum': '0.10'}] #[{'PerpendicularTo':"[0,K,0]",'Minimum':'-0.05','Maximum':'0.05'},{'PerpendicularTo':"[0,K,0]",'Minimum':'10.95','Maximum':'11.05'},{'PerpendicularTo':"[0,K,0]",'Minimum':'0.95','Maximum':'1.05'}]
...
if __name__ == "__main__":
    ...
    mdraw = ConvertToMD(raw,QDimensions="Q3D",dEAnalysisMode="Elastic",Q3DFrames=Q3DFrames,QConversionScales=QConversionScales,
                        ...
                        MinValues='-0.5,-3.1,-1.5',MaxValues='6.5,2.1,1.5',
