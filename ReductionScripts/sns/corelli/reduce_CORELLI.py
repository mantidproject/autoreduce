...
class processInputs(object):
    def __init__(self):
        ...
        self.plot_requests=[{'Minimum': '-0.05', 'PerpendicularTo': 'Q_sample_y', 'Maximum': '0.05'}] #[{'PerpendicularTo':"[0,K,0]",'Minimum':'-0.05','Maximum':'0.05'},{'PerpendicularTo':"[0,K,0]",'Minimum':'10.95','Maximum':'11.05'},{'PerpendicularTo':"[0,K,0]",'Minimum':'0.95','Maximum':'1.05'}]
