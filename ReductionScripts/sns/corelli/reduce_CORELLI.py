...
class processInputs(object):
    def __init__(self):
        #templated stuff
        self.ub_matrix_file='/SNS/CORELLI/IPTS-15643/shared/FeGa_No1_UB.mat' #'/SNS/CORELLI/IPTS-12310/shared/Sr214-Tb1000-2nd-20150512/UB-H0L-may12.mat'
        ...
        self.plot_requests=[{'Minimum': '-0.1', 'PerpendicularTo': '[H,0,-H]', 'Maximum': '0.1'}, {'Minimum': '-0.1', 'PerpendicularTo': '[0,K,0]', 'Maximum': '0.1'}] #[{'PerpendicularTo':"[0,K,0]",'Minimum':'-0.05','Maximum':'0.05'},{'PerpendicularTo':"[0,K,0]",'Minimum':'10.95','Maximum':'11.05'},{'PerpendicularTo':"[0,K,0]",'Minimum':'0.95','Maximum':'1.05'}]
