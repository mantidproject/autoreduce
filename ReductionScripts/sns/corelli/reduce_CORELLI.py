...
class processInputs(object):
    def __init__(self):
        #templated stuff
        self.ub_matrix_file='/SNS/CORELLI/IPTS-12310/shared/20151121-Na2IrO3/UB_quick.mat' #'/SNS/CORELLI/IPTS-12310/shared/Sr214-Tb1000-2nd-20150512/UB-H0L-may12.mat'
        self.vanadium_SA_file='/SNS/CORELLI/shared/Vanadium/SolidAngle20151119New2.nxs' #'/SNS/CORELLI/shared/Vanadium/SolidAngle20150411.nxs'
        self.vanadium_flux_file='/SNS/CORELLI/shared/Vanadium/Spectrum20151119New2.nxs' #'/SNS/CORELLI/shared/Vanadium/Spectrum20150411.nxs'
...
if __name__ == "__main__":
    ...
    mdraw = ConvertToMD(raw,QDimensions="Q3D",dEAnalysisMode="Elastic",Q3DFrames=Q3DFrames,QConversionScales=QConversionScales,
                        ...
                        MinValues='-5.1,-0.1,-1.5',MaxValues='5.1,8.1,1.5',
