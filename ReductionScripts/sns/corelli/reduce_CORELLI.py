...
class processInputs(object):
    def __init__(self):
        ...
        self.plot_requests=[{'Minimum': '2.90', 'PerpendicularTo': '[0,0,L]', 'Maximum': '3.10'}] #[{'PerpendicularTo':"[0,K,0]",'Minimum':'-0.05','Maximum':'0.05'},{'PerpendicularTo':"[0,K,0]",'Minimum':'10.95','Maximum':'11.05'},{'PerpendicularTo':"[0,K,0]",'Minimum':'0.95','Maximum':'1.05'}]
