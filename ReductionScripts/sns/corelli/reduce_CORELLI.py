...
class processInputs(object):
    def __init__(self):
        #templated stuff
        self.ub_matrix_file='/SNS/CORELLI/IPTS-17922/shared/SaE/quickUB.mat' #'/SNS/CORELLI/IPTS-12310/shared/Sr214-Tb1000-2nd-20150512/UB-H0L-may12.mat'
        self.vanadium_SA_file='/SNS/CORELLI/shared/Vanadium/2017A/SolidAngle_SlimSam_20170301cc.nxs' #'/SNS/CORELLI/shared/Vanadium/SolidAngle20150411.nxs'
