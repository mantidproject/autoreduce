...
if __name__ == "__main__":
    ...
    RawVanadium="/SNS/SEQ/IPTS-16076/nexus/SEQ_89042.nxs.h5"
    ProcessedVanadium="van89042_a.nxs"
    HardMaskFile=''
    ...
    MaskBTPParameters.append({'Tube': '8', 'Bank': '43'})
    ...
    if not numpy.isnan(Ei):
        ...
        DGSdict['EnergyTransferRange']=[-0.5*EGuess,0.01*EGuess,0.95*EGuess]  #Typical values are -0.5*EGuess, 0.005*EGuess, 0.95*EGuess
