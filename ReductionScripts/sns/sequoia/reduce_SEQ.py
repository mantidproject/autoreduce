...
if __name__ == "__main__":
    ...
    MaskBTPParameters.append({'Bank': '98-115,137-150'})
    MaskBTPParameters.append({'Bank': '61-76,38-39'})
 ...
 #   MaskBTPParameters.append({'Bank':"61-74,98-113,137-150"})
    ...
    if not math.isnan(Ei):
        ...
        DGSdict['EnergyTransferRange']=[-0.9*EGuess,0.005*EGuess,0.89*EGuess]  #Typical values are -0.5*EGuess, 0.005*EGuess, 0.95*EGuess
