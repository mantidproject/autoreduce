...
if __name__ == "__main__":
    ...
    RawVanadium="/SNS/SEQ/IPTS-11764/nexus/SEQ_64563.nxs.h5"
 ...
 #   MaskBTPParameters.append({'Bank':"61-74,98-113,137-150"})
    ...
    if not math.isnan(Ei):
        ...
        DGSdict['EnergyTransferRange']=[-0.95*EGuess,0.005*EGuess,0.9*EGuess]  #Typical values are -0.5*EGuess, 0.005*EGuess, 0.95*EGuess
