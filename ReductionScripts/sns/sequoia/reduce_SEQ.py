...
if __name__ == "__main__":
    ...
    ProcessedVanadium="van81711_C.nxs"
    HardMaskFile=''
    ...
    if not numpy.isnan(Ei):
        ...
        DGSdict['EnergyTransferRange']=[-0.05*EGuess,0.005*EGuess,0.95*EGuess]  #Typical values are -0.5*EGuess, 0.005*EGuess, 0.95*EGuess
