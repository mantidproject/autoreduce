...
{"use_sangle":False, "use_const_q":False, "fit_peak_in_roi":True, "use_roi_bck":True,
 "force_peak":False, "peak_min":176, "peak_max":200, "force_background":True,
 "bck_min":75, "bck_max":130, "use_side_bck":False, "bck_width":10
}
END_JSON
    """
    ...
    red = refm.ReductionProcess(data_run=event_file_path,
                                ...
                                force_bck_roi=True, bck_roi=[75, 130],
