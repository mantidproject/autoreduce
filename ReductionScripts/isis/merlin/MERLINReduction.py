...
#---------------------------------------------------------------------------#
      ...
      # multiple energies provided in the data file
       ei=[153,49,24] #[150,64,36] # multiple energies provided in the data file
       ...
       prop['sample_run'] = range(25968,27000) # 'MER23700.n001'
       prop['wb_run'] = '25124.raw'
       #
...
#------------------------------------------------------------------------------------#
   ...
   def def_advanced_properties(self):
      ...
      """
      prop = {}
      prop['map_file'] = 'one2one_151.map'
      prop['det_cal_file'] = 'det_corr_151.dat' #'det_corrected7.nxs - testing'
      prop['bleed'] = True
      ...
      prop['ei-mon1-spec']=[69634,69635,69637]
      #prop[fix_ei]=True
